...
public class CommentServiceImpl implements CommentService {
    ...
    public CommentDto update(CommentParam commentParam) {
        ...
        if (maybeComment.isEmpty()) {
            log.warn("Comment with id = {} not found", commentParam.getEventId());
            throw new NotFoundException(String.format("Comment with id = %d not found", commentParam.getEventId()));
        }
    ...
    public void deleteByUser(CommentParam commentParam) {
        ...
        if (!userRepository.existsById(commentParam.getUserId())) {
            log.warn("User with id = {} not found", commentParam.getUserId());
            throw new NotFoundException(String.format("User with id = %d not found", commentParam.getUserId()));
        }
    ...
    public void deleteByAdmin(Long eventId, Long commentId) {
        ...
        if (maybeComment.isEmpty()) {
            log.warn("Comment with id = {} not found", eventId);
            throw new NotFoundException(String.format("Comment with id = %d not found", eventId));
        }
    ...
    public List<CommentDto> findAllByEventId(Long eventId) {
        log.debug("Comments request for eventId = {}", eventId);
